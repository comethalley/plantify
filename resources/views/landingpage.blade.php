                ...
                <div class="col-lg-8 ms-lg-auto">
                    <div class="row">
                        <div class="col-sm-4 mt-4">
                            ...
                            <div class="text-muted mt-2">
                                <ul class="list-unstyled ff-secondary footer-list ">
                                    <li><a class="text-white ">About CUAI </a></li>
                                    <li><a class="text-white ">FAQS</a></li>
                        ...
                        <div class="col-sm-4 mt-4">
                            ...
                            <div class="text-muted mt-2">
                                <ul class="list-unstyled ff-secondary footer-list">
                                    <li><a class="text-white ">How it works</a></li>
                                    <li><a class="text-white">Learn More</a></li>
                                    <li><a class="text-white ">To Explore</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-4 mt-4">
                            ...
                            <div class="text-muted mt-2">
                                <ul class="list-unstyled ff-secondary footer-list">
                                    ...
                                    <li><a class="text-white "><i class="fas fa-phone-alt"></i> (+63) 927-1168-609</a></li>
