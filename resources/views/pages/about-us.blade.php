...
<body data-bs-spy="scroll" data-bs-target="#navbar">
    ...
    <br>
    <br>
    <section id="home-section" class="section nft-hero" id="hero" style="background-image: url('assets/images/plantifeedpics/grass.png'); background-size: cover; background-position: center center;">
        ...
        <div class="row gy-4 justify-content-center">
                ...
                <div class="card plan-box h-100 mb-0">
                    <div class="card-body p-4 m-2">
                        <div class="text-center">
                            <img src="assets/images/plantifeedpics/Mission.png" alt="" class="img-fluid"><br><br>
                            <h4 class="text-center m-2">OUR MISSION</h4>
                            <p class="text-muted mb-0" style="text-align: justify center;">To be the hub of urban agriculture and innovation initiatives to achieve the sustainable development goals.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card plan-box h-100 mb-0">
                    <div class="card-body p-4 m-2">
                        <div class="text-center">
                            <img src="assets/images/plantifeedpics/CUAI.jpg" alt="" class="img-fluid" style="max-height: 190px;">
                        </div>
            ...
            <div class="col-lg-4">
                <div class="card plan-box h-100 mb-0">
                    <div class="card-body p-4 m-2">
                        <div class="text-center">
                            <img src="assets/images/plantifeedpics/Vision.png" alt="" class="img-fluid"><br><br>
                            <h4 class="text-center m-2">OUR VISION</h4>
                            <p class="text-muted mb-0" style="text-align: justify center;">To be recognized as the leader in urban agriculture and innovation.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-sm-4 mt-4">
                            ...
                            <div class="text-muted mt-2">
                                <ul class="list-unstyled ff-secondary footer-list">
                                    ...
                                    <li><a class="text-white "><i class="fas fa-envelope"></i> Send us a Message</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
