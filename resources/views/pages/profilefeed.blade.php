...
<body>
    ...
    <div class="main-content" style="margin-top: 40px;">
        ...
        <div class="profile-flex" style="display: flex; flex-direction:column; align-items:center; row-gap:10px;">
            ...
            @endif
            <div style="display:grid;  grid-template-columns: 200px 200px; justify-content:space-between;  width:1080px; padding:30px; background-color:#FFFFFF;   box-shadow: 0 3px 10px rgb(0 0 0 / 0.2); border-radius: 10px; ">
                ...
                <div style="display: flex;">
                    ...
                    @endif
                    <span class="text-start ms-xl-2" style="text-align: start; margin-top:25px;">
                        @if (Auth::check())
                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text" style="font-size: 32px;">{{ Auth::user()->firstname }}</span>
                        @if (Auth::user()->role_id == 1)
                        <span class="d-none d-xl-block ms-1 fs-14 user-name-sub-text  ">Super Admin </span>
                        @endif
                        @if (Auth::user()->role_id == 2)
                        <span class="d-none d-xl-block ms-1 fs-14 user-name-sub-text">Admin</span>
                        @endif
                        @if (Auth::user()->role_id == 3)
                        <span class="d-none d-xl-block ms-1 fs-14 user-name-sub-text">Farm Leader</span>
                        @endif
                        @if (Auth::user()->role_id == 4)
                        <span class="d-none d-xl-block ms-1 fs-14 user-name-sub-text">Farmer</span>
                        @endif
                        @if (Auth::user()->role_id == 5)
                        <span style="color: gray;" class="d-none d-xl-block ms-1 fs-14 user-name-sub-text ">User</span>
                        @endif
                        @endif
            ...
            <img style=" width: 100%; height:350px; background-color: whitesmoke; ">
            <div style="display: flex; align-items: flex-start; flex-direction: column; width: 1080px; padding: 20px; background-color: #FFFFFF; box-shadow: 0 3px 10px rgb(0 0 0 / 0.2); border-radius: 10px;">
                <div style="display: flex; justify-content: space-between; width:100%;;">
                    <div style="display: flex;">
                        <img style="padding: 15px; width: 160px; height: 160px; border-radius: 50%; object-fit: cover; box-shadow: 0 3px 10px rgb(0 0 0 / 0.2);" src="{{ asset('assets/images/plantifeedpics/profile-icon.png') }}" alt="Default Profile Photo">
                        <span class="text-start ms-xl-2" style="text-align: start; margin-top:25px;">
                            @if (Auth::check())
                            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text" style="font-size: 32px;">{{ Auth::user()->firstname }}</span>
                            @if (Auth::user()->role_id == 1)
            ...
            <div style="margin-top:17px; display: grid; grid-template-columns:530px 530px; column-gap:20px; justify-content:center;">
                <div style="max-width:530px;max-height:600px; padding:40px; background-color:#FFFFFF; box-shadow: 0 3px 10px rgb(0 0 0 / 0.2); border-radius: 10px;">
                    ...
                    <div style="display: flex; flex-direction:column; row-gap:20px; ">
                        ...
                        <span>
                            ...
                            <span class="text-start " style="text-align: start; margin-top:25px;">
                                @if (Auth::check())
                                <span class="d-none d-xl-inline-block ms-1 fw-normal user-name-text" style="font-size: 12px;">{{ Auth::user()->email}}</span>
                                @if (Auth::user()->role_id == 1)
                                <span class="d-none d-xl-block ms-1 fs-14 user-name-sub-text  ">Super Admin </span>
                                @endif
                                @if (Auth::user()->role_id == 2)
                    ...
                    <p style="font-weight: bold; font-size:18px; margin-top:20px;"> Bio </p>
                    ...
                    <div style="display: flex; flex-direction:column; row-gap:20px; ">
                        ...
                        <span>
                            ...
                            <span class="text-start " style="text-align: start; margin-top:25px;">
                                @if (Auth::check())
                                <span class="d-none d-xl-inline-block  fw-normal user-name-text" style="font-size: 13px;">{{ Auth::user()->email }}</span>
                                @if (Auth::user()->role_id == 1)
                        ...
                        @if(empty($userBio))
                        <p style="text-align: center;">No bio yet</p>
                        @else
                        <p style="text-align: center;">{{ $userBio }}</p>
                        @endif
