                                    ...
                                    <table class="table table-nowrap align-middle" id="orderTable">
                                        ...
                                        <tbody class="">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->pes_name }}</td>
                                                <td><img src="/images/{{ $item->pes_image }}" alt=""  height="100px" width="200px"></td>
                                                ...
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                            <a class="text-danger d-inline-block remove-pes-btn" data-bs-toggle="modal" href="#deleteOrder" data-pesticides-id="{{$item->id}}">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form method="POST" action="" style="display:inline">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="pesticide-archive">Yes, Delete It</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
