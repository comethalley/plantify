    ...
    function populateUomTable(data) {
        ...
        $.each(data.admins, function(index, admin) {
            var row = "<tr>" +
                ...
                "<td class='customer_name'>" + admin.firstname + "</td>" +
                "<td class='customer_name'>" + admin.lastname + "</td>" +
                "<td class='customer_name'>" + admin.email + "</td>" +
                "<td><ul class='list-inline gap-2 mb-0'><li class='list-inline-item edit' data-bs-toggle='tooltip' data-bs-trigger='hover' data-bs-placement='top' title='Edit'><a href='' class='text-primary d-inline-block edit_admin_btn' data-admin-id='" + admin.id + "'><i class='ri-pencil-fill fs-16'></i></a></li><li class='list-inline-item' data-bs-toggle='tooltip' data-bs-trigger='hover' data-bs-placement='top' title='Remove'><a class='text-danger d-inline-block archive_admin_btn' href='' data-admin-id='" + admin.id + "'><i class='ri-delete-bin-5-fill fs-16'></i></a></li></ul></td>" +
                "</tr>";
