                    ...
                    <div class="d-flex align-items-flex-start justify-content-between">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                ...
                                <button style="background-color: transparent; border: none; color: black; margin-right: 50px; font-size: 14px;" onmouseover="this.style.color='black'" onmouseout="this.style.color='black'">💬 Comment</button>
                            </div>
                        </div>
