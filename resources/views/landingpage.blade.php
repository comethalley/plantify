...
<!-- end features -->
  ...
  <div class="accordion-item">
    ...
    <div class="accordion-body"style="text-align: justify;">This platform is designed to support the Center for Urban Agriculture and Innovation. It serves as a tool and guide for urban farmers to effectively manage their urban gardens.</div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body"style="text-align: justify;">The platform can be accessed on mobile devices and web browsers. Whether you're outside or in your urban garden, you can use the platform.</div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingFour">
      ...
      <h5>Can anyone share their story on the community forum?</h5>
      </button>
    </h2>
    <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body"style="text-align: justify;">Everyone can share their story on the community forum because it is designed to listen to the voices of every urban farmer. Whether you are a public user, farmer, or farmer leader, each of your posts is valuable to us.</div>
