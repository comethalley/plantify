                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="firstName" name="first_name" value="{{ $user->firstname }}" placeholder="First Name" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div>
                                                    <label for="lastName" class="form-label">Last Name</label>
                                                    <input type="text" class="form-control" id="lastName" name="last_name" value="{{ $user->lastname }}" placeholder="Last Name"  readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div>
                                ...
                                <div class="row gy-4"> 
                                    <div class="col">
                                        <div>
                                            ...
                                            <div class="form-icon">
                                                <input type="email" class="form-control form-control-icon" id="iconInput" name="email" value="{{ $user->email }}" placeholder="example@gmail.com" readonly>
