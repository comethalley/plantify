...
<div class="main-content">
    <div class="page-content">
        ...
        <div class="page-content">
            <div class="wrapper">
                <div class="main">
                    <!-- Temp, Date, and Location should be defined -->
                            ...
                            <div class="card-header p-0 border-0 bg-light-subtle">
                                <div class="row g-0 text-center">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1">
                                                <span class="counter-value" data-target="228">0</span>
                                            </h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0 border-end-0">
                                            ...
                                            <p class="text-muted mb-0">Total Harvest</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-success fw-medium mb-0">
                                        <span class="badge bg-success-subtle text-success p-1 rounded-circle"><i class="ri-arrow-right-up-line"></i></span>
                                        +3 New
                                    </p>
                                </div>
                            </div>
