...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
                        ...
                        <div class="d-flex align-items-center ">
                            <div class="flex-grow-1">
                                <h4 class="mb-1 fw-semibold text-center">
                                    <img src="assets/images/plantifeedpics/weather 1.png" alt="" class="img-fluid"> Weather Monitoring
                                    <hr>
                                </h4><br>
                ...
                <div class=" plan-box h-100 mb-0">
                    <div class="card-body p-4 m-2">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h4 class="mb-1 fw-semibold text-center">
                                    <img src="assets/images/plantifeedpics/analytics 1.png" alt="" class="img-fluid"> Analytics
                                    <hr>
                                </h4><br>
                ...
                <div class=" plan-box h-100 mb-0">
                    <div class="card-body p-4 m-2">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h4 class="mb-1 fw-semibold text-center">
                                    <img src="assets/images/plantifeedpics/calendar 1.png" alt="" class="img-fluid"> Planting Calendar
                                    <hr>
                                </h4><br>
    ...
    <!-- <section class="section bg-light" id="marketplace"style="padding-bottom:20px;"> -->
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="assets/images/plantifeedpics/news1.jpg" alt="" class="card-img-top explore-img" />
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="assets/images/plantifeedpics/news7.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="assets/images/plantifeedpics/news4.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="assets/images/plantifeedpics/news5.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="assets/images/plantifeedpics/news6.jpg" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
    ...
    <!-- <section class="section bg-light" id="plans"> -->
            ...
            <img src="assets/images/plantifeedpics/event1.jpg" class="card-img-top" alt="Image">
            <div class="card-body p-4 m-2">
                <div class="d-flex align-items-center justify-center">
                    ...
                    <div class="col-lg-4">
                    <div class="card plan-box mb-0">
            <img src="assets/images/plantifeedpics/event2.jpg" class="card-img-top" alt="Image">
            <div class="card-body p-4 m-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                    <h5 class="mb-1"><a href="/" style="color: #066903;">Hydroponics at Urban<br>Gardening Livelihood Training</a></h5>
                    ...
                    <div class="col-lg-4">
                    <div class="card plan-box mb-0">
            <img src="assets/images/plantifeedpics/event3.jpg" class="card-img-top" alt="Image">
            <div class="card-body p-4 m-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                    <h5 class="mb-1"><a href="/" style="color: #066903;">Hydroponics at Urban<br>Gardening Livelihood Training</a></h5>
                    ...
                    <div class="swiper effect-coverflow-swiper rounded pb-5 swiper-coverflow swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress">
                        <div class="swiper-wrapper" id="swiper-wrapper-93239b4b57f8d37f" aria-live="off" style="cursor: grab; transition-duration: 300ms; transform: translate3d(-450.75px, 0px, 0px);">
                            <div class="swiper-slide" role="group" aria-label="5 / 6" data-swiper-slide-index="4" style="width: 300.5px; transition-duration: 300ms; transform: translate3d(0px, 0px, -300px) rotateX(0deg) rotateY(150deg) scale(1); z-index: -2;">
                                ...
                                <div class="swiper-slide-shadow-left swiper-slide-shadow-coverflow" style="opacity: 3; transition-duration: 300ms;"></div>
                                <div class="swiper-slide-shadow-right swiper-slide-shadow-coverflow" style="opacity: 0; transition-duration: 300ms;"></div>
                            </div>
                            <div class="swiper-slide swiper-slide-visible" role="group" aria-label="6 / 6" data-swiper-slide-index="5" style="width: 300.5px; transition-duration: 300ms; transform: translate3d(0px, 0px, -200.166px) rotateX(0deg) rotateY(100.083deg) scale(1); z-index: -1;">
                                <img src="assets/images/vegetables/img2.jpg" alt="" class="img-fluid">
                                <div class="swiper-slide-shadow-left swiper-slide-shadow-coverflow" style="opacity: 2.00166; transition-duration: 300ms;"></div>
                                <div class="swiper-slide-shadow-right swiper-slide-shadow-coverflow" style="opacity: 0; transition-duration: 300ms;"></div>
                            </div>
                            <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-prev" role="group" aria-label="1 / 6" data-swiper-slide-index="0" style="width: 300.5px; transition-duration: 300ms; transform: translate3d(0px, 0px, -100px) rotateX(0deg) rotateY(50deg) scale(1); z-index: 0;">
                                <img src="assets/images/vegetables/img3.jpg" alt="" class="img-fluid">
                                <div class="swiper-slide-shadow-left swiper-slide-shadow-coverflow" style="opacity: 1; transition-duration: 300ms;"></div>
                                <div class="swiper-slide-shadow-right swiper-slide-shadow-coverflow" style="opacity: 0; transition-duration: 300ms;"></div>
                            </div>
                            <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" role="group" aria-label="2 / 6" data-swiper-slide-index="1" style="width: 300.5px; transition-duration: 300ms; transform: translate3d(0px, 0px, -0.166389px) rotateX(0deg) rotateY(0.0831947deg) scale(1); z-index: 1;">
                                <img src="assets/images/vegetables/img4.jpg" alt="" class="img-fluid">
                                <div class="swiper-slide-shadow-left swiper-slide-shadow-coverflow" style="opacity: 0.00166389; transition-duration: 300ms;"></div>
                                <div class="swiper-slide-shadow-right swiper-slide-shadow-coverflow" style="opacity: 0; transition-duration: 300ms;"></div>
                            </div>
                            <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-next" role="group" aria-label="3 / 6" data-swiper-slide-index="2" style="width: 300.5px; transition-duration: 300ms; transform: translate3d(0px, 0px, -100px) rotateX(0deg) rotateY(-50deg) scale(1); z-index: 0;">
                                <img src="assets/images/vegetables/img5.jpg" alt="" class="img-fluid">
                                <div class="swiper-slide-shadow-left swiper-slide-shadow-coverflow" style="opacity: 0; transition-duration: 300ms;"></div>
                                <div class="swiper-slide-shadow-right swiper-slide-shadow-coverflow" style="opacity: 1; transition-duration: 300ms;"></div>
                            </div>
                            <div class="swiper-slide swiper-slide-visible" role="group" aria-label="4 / 6" data-swiper-slide-index="3" style="width: 300.5px; transition-duration: 300ms; transform: translate3d(0px, 0px, -199.834px) rotateX(0deg) rotateY(-99.9168deg) scale(1); z-index: -1;">
                                <img src="assets/images/vegetables/img6.jpg" alt="" class="img-fluid">
                                <div class="swiper-slide-shadow-left swiper-slide-shadow-coverflow" style="opacity: 0; transition-duration: 300ms;"></div>
                                <div class="swiper-slide-shadow-right swiper-slide-shadow-coverflow" style="opacity: 1.99834; transition-duration: 300ms;"></div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="text-center">
                                                <p class="mb-4">&copy;
                                                    ...
                                                    </script> CUAI <i class="mdi mdi-heart" style="color: darkgreen; "></i>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
