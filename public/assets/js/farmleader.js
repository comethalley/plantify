    ...
    function populateFarmLeaderTbl(data) {
        ...
        $.each(data.farmLeaders, function(index, farmLeader) {
            var row = "<tr>" +
                ...
                "<td class='customer_name'>" + farmLeader.firstname + "</td>" +
                "<td class='customer_name'>" + farmLeader.lastname + "</td>" +
                "<td class='customer_name'>" + farmLeader.email + "</td>" +
                "<td><ul class='list-inline gap-2 mb-0'><li class='list-inline-item edit' data-bs-toggle='tooltip' data-bs-trigger='hover' data-bs-placement='top' title='Edit'><a href='' class='text-primary d-inline-block edit_farmleader_btn' data-farmLeader-id='" + farmLeader.id + "'><i class='ri-pencil-fill fs-16'></i></a></li><li class='list-inline-item' data-bs-toggle='tooltip' data-bs-trigger='hover' data-bs-placement='top' title='Remove'><a class='text-danger d-inline-block archive_farmleader_btn' href='' data-farmLeader-id='" + farmLeader.id + "'><i class='ri-delete-bin-5-fill fs-16'></i></a></li></ul></td>" +
                "</tr>";
