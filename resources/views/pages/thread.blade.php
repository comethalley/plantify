        ...
        function updateConversation(messages) {
            ...
            imageSets.forEach(function(imageSet) {
                ...
                imageSet.forEach(function(imagePath) {
                    ...
                    var imageItem = $('<img src="{{ asset('
                        storage ') }}/' + imagePath + '" style="max-width: 100px; max-height: 100px;" class="img-fluid img-thumbnail attached-image" alt="Attached Image">');
            ...
            messages.forEach(function(message) {
                ...
                if (message.text_content) {
                    ...
                    messageContent = $('<div class="conversation-list">' +
                        ...
                        '</div>' +
                        '<img src="{{ asset('
                        storage ') }}/' + message.image_path + '" style="max-width: 200px; max-height: 200px;" class="img-fluid" alt="Image">' +
                        ...
                        '<li><a class="dropdown-item" href="{{ asset('
                        storage ') }}/' + message.image_path + '" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a></li>' +
                    ...
                    var modalContent = '<div class="modal-dialog modal-dialog-centered modal-xl">' +
                        ...
                        '<img src="{{ asset('
                    storage ') }}/' + message.image_path + '" class="img-fluid" alt="Image">' +
                        '</div>' +
                        '</div>' +
                        '</div>';
